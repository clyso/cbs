...
class GPGPlainSecret(PlainSecret):
    ...
    type: Literal["gpg-armor-key"] = "gpg-armor-key"
...
def signing_secret_discriminator(
    ...
    if secret["creds"] == "plain" and secret["type"] == "gpg-armor-key":
        return "plain-gpg-key"
...
SigningSecret = Annotated[
    Annotated[GPGPlainSecret, pydantic.Tag("plain-gpg-key")]
    | Annotated[GPGVaultSingleSecret, pydantic.Tag("vault-gpg-single-key")]
